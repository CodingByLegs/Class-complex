...
int main() {
  ...
  */
  Complex c8;
  c8 = c3 - c2;                                       // применение перегруженой операции сложения
  cout << "Результат вычитания с помощью перегруженного оператора: c8 = c3 + c2 = ";
  cout << c8 << endl;

  Complex c9;
  c9 = c3 * c2;                                       // применение перегруженой операции сложения
  cout << "Результат усножения с помощью перегруженного оператора: c9 = c3 + c2 = ";
  cout << c9 << endl;

  Complex c10;
  c10 = c3 / c2;                                       // применение перегруженой операции сложения
